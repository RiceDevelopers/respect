...
const PRODUCTS = [
    ...
    {id:8,name:"نسمة الفجر",category:"يونيسكس",price:17.500,stock:40,badge:"الأحب للعملاء",desc:"خفيف كنسمة الفجر",notes:"العلوية: شاي أخضر | القلب: فريزيا | القاعدة: مسك أبيض",sizes:["30ml","50ml","100ml"],img:"https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=200&h=200&fit=crop",imgs:["https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=600&h=600&fit=crop"],active:true,featured:false}
];
