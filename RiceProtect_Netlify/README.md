...
## Netlify Database v4.1
Uses `@netlify/database` to resolve the active branch connection and includes an automatic migration in `netlify/database/migrations`. Do not create `DATABASE_URL` manually when using Netlify Database.
