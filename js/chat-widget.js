...
class ChatWidget {
  constructor() {
    ...
    this.responses = {
      ...
      products: [
        'لدينا تشكيلة رائعة من الهدايا:\n• كيك فاخر (من 8.5 د.ك)\n• باقات ورد (من 7.5 د.ك)\n• هدايا مميزة (من 12 د.ك)\n• شوكولاتة بلجيكية (من 5 د.ك)',
        'هل تبحث عن شيء معين؟ أخبرني بالمناسبة وسأقترح لك الهدية المثالية ✨'
      ],
      delivery: [
  ...
  generateResponse(userMessage) {
    ...
    if (this.containsAny(message, ['منتج', 'هدية', 'كيك', 'ورد', 'شوكولاتة', 'gift', 'product'])) {
  ...
  handlePriceQuery(message) {
    ...
    if (message.includes('شوكولاتة')) {
      return 'الشوكولاتة الفاخرة متوفرة من 5 د.ك للعلب الصغيرة إلى 18 د.ك للعلب الكبيرة';
    }
